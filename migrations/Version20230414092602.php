...
final class Version20230414092602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, salle_id INT NOT NULL, type_reservation_id INT NOT NULL, gestionnaire_salle_id INT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, date_debut DATETIME NOT NULL, duree VARCHAR(255) DEFAULT NULL, date_fin DATETIME NOT NULL, nombre_participant INT DEFAULT NULL, INDEX IDX_42C84955DC304035 (salle_id), INDEX IDX_42C84955EEF1BE73 (type_reservation_id), INDEX IDX_42C84955F808B1C7 (gestionnaire_salle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
