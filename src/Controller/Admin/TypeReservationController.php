...
#[Route('/admin/type-reservation')]
class TypeReservationController extends AbstractController
{
    #[Route('/', name: 'app_admin_type_reservation_index', methods: ['GET'])]
    public function index(TypeReservationRepository $typeReservationRepository): Response
    {
        return $this->render('admin/type_reservation/index.html.twig', [
            'type_reservations' => $typeReservationRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_admin_type_reservation_new', methods: ['GET', 'POST'])]
    public function new(Request $request, TypeReservationRepository $typeReservationRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_type_reservation_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('admin/type_reservation/new.html.twig', [
            'type_reservation' => $typeReservation,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_type_reservation_show', methods: ['GET'])]
    public function show(TypeReservation $typeReservation): Response
    {
        return $this->render('admin/type_reservation/show.html.twig', [
            'type_reservation' => $typeReservation,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_admin_type_reservation_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, TypeReservation $typeReservation, TypeReservationRepository $typeReservationRepository): Response
    {
        ...
        return $this->renderForm('admin/type_reservation/edit.html.twig', [
            'type_reservation' => $typeReservation,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_type_reservation_delete', methods: ['POST'])]
